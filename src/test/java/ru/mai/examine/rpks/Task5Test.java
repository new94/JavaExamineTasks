...
@Slf4j
class Task5Test extends Infrastructure {
     ...
     * возвращаем в endpoint значение из Redis в верхнем регистре и с обратным порядком букв
     *
