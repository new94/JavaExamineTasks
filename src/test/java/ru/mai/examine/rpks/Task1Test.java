...
@Slf4j
class Task1Test extends Infrastructure {
     ...
     * возвращаем в endpoint количество найденых строк в PostgreSQL
     *
    ...
    void task1() throws Exception {
        this.mockMvc.perform(get("/task1?bootstrapServers=" + kafka.getBootstrapServers() + "&topic=test_topic_in"))
                .andDo(print())
                .andExpect(status().isOk())
